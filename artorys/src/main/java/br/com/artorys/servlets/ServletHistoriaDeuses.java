...
@WebServlet(urlPatterns = "/comprarhistoriadeuses")
public class ServletHistoriaDeuses extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("</script>");
		request.getRequestDispatcher("/front/baixarhistoriadeuses.html").include(request, response);
	}
